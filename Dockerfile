...
# Instala apenas o necessário no Debian
...
# SENHA OBRIGATÓRIA: Exigida pelo ModelScope
ENV VNC_PW=123456
...
# Cria o arquivo de inicialização chamando o websockify diretamente de forma limpa
