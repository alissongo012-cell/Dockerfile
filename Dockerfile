...
# Instala o Chromium real do Debian (sem snap), VNC, noVNC e fontes reais
...
# Cria a configuração do supervisor de forma limpa e compatível com usuário comum
...
# FLAGS ANTI-DETEÇÃO: Camufla o navegador para esconder o facto de estar num servidor e abre o site
