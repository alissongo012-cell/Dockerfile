# Usa uma imagem oficial que está dentro do servidor deles e nunca é bloqueada
FROM ://aliyuncs.com

USER root

# Atualiza e instala a parte gráfica básica de forma direta
...
# FLAGS ANTI-DETEÇÃO: Abre o navegador e camufla para o site Dropcoins
