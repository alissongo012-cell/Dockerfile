...
# Instala as ferramentas gráficas, fontes e o Chromium de forma estável no Ubuntu
...
# FLAGS ANTI-DETEÇÃO: Camufla o navegador para esconder o fato de ser um servidor/bot
